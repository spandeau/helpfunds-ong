  ...
  return (
    <div className="group bg-white rounded-2xl p-6 border border-neutral-100 hover:border-primary-200 hover:shadow-lg transition-all duration-300 text-center">
      ...
      <div className="mt-4 flex items-center justify-center gap-3 text-xs font-medium">
        ...
        {member.twitter && (
          <a href={member.twitter} target="_blank" rel="noopener noreferrer" className="text-neutral-600 hover:underline">
            Twitter
          </a>
        )}
        {member.email && (
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-primary-900 to-primary-950 rounded-3xl p-8 md:p-12 text-center">
            ...
            <a
              href={"mailto:helpfunds17@gmail.com?subject=Candidature Help Funds"}
              className="inline-flex items-center gap-2 bg-secondary-600 hover:bg-secondary-500 text-white px-8 py-3 rounded-full font-bold transition-colors"
            >
              Nous contacter
            </a>
          </div>
